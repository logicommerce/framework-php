...
class RoutePaths {
    ...
    protected static function getArrayRouteTypePaths(): array {
        return [
            ...
            InternalAccount::USED_ACCOUNT_SWITCH => '/' . INTERNAL_PREFIX . '/account/used_account_switch',
            ...
            RouteType::ACCOUNT_ADDRESS => '/accounts/{' . Parameters::ACCOUNT_ID . '}/addresses/{' . Parameters::ADDRESS_ID . '}', // /accounts/{id or 'used'}/addresses/{id}
