...
class RoutePaths {
    ...
    protected static function getArrayRouteTypePaths(): array {
        return [
            ...
            InternalBasket::GET_DELIVERY => '/' . INTERNAL_PREFIX . '/basket/get_delivery',
            ...
            InternalCheckout::EXPRESS_CHECKOUT_ACCOUNT => '/' . INTERNAL_PREFIX . '/checkout/express_checkout_account',
