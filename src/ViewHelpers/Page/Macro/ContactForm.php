...
/**
 * This is the ContactForm class, a macro class for the PageViewHelper.
 * The purpose of this class is to encapsulate the logic that calculates the view parameters for the user's ContactForm.
 *
 * @see ContactForm::getViewParameters()
 *
...
class ContactForm {
    ...
    /**
     * Constructor method for ContactForm.
     * 
     * @see ContactForm
     * 
