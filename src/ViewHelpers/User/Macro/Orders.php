 ...
 *
 * @see Orders::ACTION_VIEW
 * @see Orders::ACTION_VIEW_PDF
 * @see Orders::ACTION_RECOVER
 * @see Orders::ACTION_DELIVERY_NOTE
 * @see Orders::ACTION_DELIVERY_NOTE_PDF
 * @see Orders::ACTION_INVOICE
 * @see Orders::ACTION_INVOICE_PDF
 * @see Orders::ACTION_RETURN
 * @see Orders::ACTION_RETURN_TRACING
 *
