...
/**
 * This is the DeleteShoppingListRowsForm class, a macro class for the userViewHelper.
 * The purpose of this class is to encapsulate the logic that calculates the view parameters for the user's shopping list.
 *
 * @see DeleteShoppingListRowsForm::getViewParameters()
 *
 * @package FWK\ViewHelpers\User\Macro
 */
class DeleteShoppingListRowsForm {
    ...
    /**
     * Constructor method for DeleteShoppingListRowsForm.
     * 
     * @see DeleteShoppingListRowsForm
     * 
