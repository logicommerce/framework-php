...
/**
 * This is the user lost Verify Controller.
 ...
 */
class VerifyController extends BaseHtmlController {
    ...
    protected function setControllerBaseData(): void {
        $response = Loader::service(Services::USER)->verifySubscriptionByToken($this->token);
        if (is_null($response->getError())) {
            $message = $this->language->getLabelValue(LanguageLabels::SUBSCRIPTION_VERIFY_OK);
        } else {
            $message = $this->language->getLabelValue(LanguageLabels::SUBSCRIPTION_VERIFY_ERROR);
        }
