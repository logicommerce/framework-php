...
/**
 * This is the DeleteComparisonProductController controller class.
 *
 * @see BaseJsonController
 *
 * @package FWK\Controllers\Comparison\Internal
 */
class DeleteComparisonProductController extends BaseJsonController {
    ...
    public function __construct(Route $route) {
        ...
        $this->responseMessage = $this->language->getLabelValue(LanguageLabels::COMPARISON_PRODUCT_STATUS_DELETE_OK, $this->responseMessage);
    }
    ...
    protected function getResponseData(): ?Element {
        $response = $this->productService->deleteProductComparison($this->appliedParameters[Parameters::ID]);
        if (is_null($response->getError())) {
            return $this->getSession()->getAggregateData()->getProductComparison();
        } elseif ($response->getError()->getCode() === 'A01000-PRODUCT_NOT_FOUND') {
