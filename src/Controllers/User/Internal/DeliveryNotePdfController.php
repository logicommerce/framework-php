 ...
 */
class DeliveryNotePdfController extends BasePdfController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetPDFDeliveryNote($requests, self::CONTROLLER_ITEM, $this->getRequestParam(Parameters::ID, true));
    }
    ...
    protected function setData(array $additionalData = []): void {
        $this->setFileName('DeliveryNote_' . $this->getRequestParam(Parameters::ID));
