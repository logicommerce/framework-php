 ...
 */
class AddWishlistProductController extends BaseJsonController {
    ...
    protected function getResponseData(): ?Element {
        ...
        $result = Loader::service(Services::USER)->addWishlistProduct($this->getRequestParam(Parameters::ID, true));
