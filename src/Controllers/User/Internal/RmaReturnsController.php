 ...
 */
class RmaReturnsController extends BaseHtmlController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetRMAReturns($requests, self::RETURNS, $this->getRequestParam(Parameters::ID, true));
    }
    ...
    protected function setControllerBaseData(): void {
        $aux = [];
        $aux[self::RETURNS] = $this->getControllerData(self::RETURNS);
