 ...
 */
class RmaPdfController extends BasePdfController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetRMAPDF($requests, self::CONTROLLER_ITEM, $this->getRequestParam(Parameters::ID, true));
    }
    ...
    protected function setData(array $additionalData = []): void {
        $this->setFileName('Rma_' . $this->getRequestParam(Parameters::ID));
