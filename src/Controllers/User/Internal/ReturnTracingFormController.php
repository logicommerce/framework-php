 ...
 */
class ReturnTracingFormController extends BaseHtmlController {

    public const RMAS = "rmas";
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetOrderRMAs($requests, self::RMAS, $this->getRequestParam(Parameters::ID, true));
    }
    ...
    protected function setControllerBaseData(): void {
        $aux = [];
        $aux[self::RMAS] = $this->getControllerData(self::RMAS);
