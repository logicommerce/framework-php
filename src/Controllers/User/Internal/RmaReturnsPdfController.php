 ...
 */
class RmaReturnsPdfController extends BasePdfController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetRMAReturnsPDF($requests, self::CONTROLLER_ITEM, $this->getRequestParam(Parameters::ID, true));
    }
    ...
    protected function setData(array $additionalData = []): void {
        $this->setFileName('RmaReturns_' . $this->getRequestParam(Parameters::ID));
