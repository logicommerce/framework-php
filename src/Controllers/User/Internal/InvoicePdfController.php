 ...
 */
class InvoicePdfController extends BasePdfController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetPDFInvoice($requests, self::CONTROLLER_ITEM, $this->getRequestParam(Parameters::ID, true));
    }
    ...
    protected function setData(array $additionalData = []): void {
        $this->setFileName('Invoice_' . $this->getRequestParam(Parameters::ID));
