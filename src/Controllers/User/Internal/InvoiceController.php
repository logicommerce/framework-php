 ...
 */
class InvoiceController extends BaseHtmlController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetInvoice($requests, self::CONTROLLER_ITEM, $this->getRequestParam(Parameters::ID, true));
    }
