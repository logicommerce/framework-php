...
/**
 * This is the DeleteShoppingListController controller class.
 ...
 */
class DeleteShoppingListController extends BaseJsonController {
    use CheckCaptcha;
    ...
    protected function getResponseData(): ?Element {
        $response = Loader::service(Services::USER)->deleteShoppingList($this->getRequestParam(Parameters::ID, true));
