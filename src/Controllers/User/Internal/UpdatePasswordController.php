 ...
 */
class UpdatePasswordController extends BaseJsonController {
    use CheckCaptcha;
    ...
    private ?UpdatePasswordParametersGroup $updatePasswordParametersGroup = null;
    ...
    public function __construct(Route $route) {
        ...
        $this->updatePasswordParametersGroup = new UpdatePasswordParametersGroup();
    }
    ...
    protected function getFilterParams(): array {
        return FormFactory::getUpdatePassword()->getInputFilterParameters();
    }
    ...
    protected function initializeAppliedParameters(): void {
        $this->appliedParameters = $this->userService->generateParametersGroupFromArray($this->updatePasswordParametersGroup, $this->getRequestParams());
    }
    ...
    protected function getResponseData(): ?Element {
        ...
        if ($this->getRequestParam(Parameters::NEW_PASSWORD, true) === $this->getRequestParam(Parameters::NEW_PASSWORD_RETYPE)) {
            $response = $this->userService->updatePassword($this->updatePasswordParametersGroup);
