...
class SalesAgentCustomerOrdersController extends BaseHtmlController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::USER)->addGetSalesAgentOrders($requests, self::CONTROLLER_ITEM, $this->getRequestParam(Parameters::CUSTOMER_ID, true), $this->salesAgentOrdersParametersGroup);
    }
