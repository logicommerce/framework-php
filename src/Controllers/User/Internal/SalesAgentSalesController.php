 ...
 * @deprecated
 */
class SalesAgentSalesController extends BaseHtmlController {
    ...
    protected function getFilterParams(): array {
        return FormFactory::getSalesAgentSales()->getInputFilterParameters();
    }
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::USER)->addGetSalesAgentSales($requests, self::SALES_AGENT_SALES, $this->salesAgentSalesParametersGroup);
    }
    ...
    protected function setControllerBaseData(): void {
        ...
        $aux[self::SALES_AGENT_SALES_FORM] = FormFactory::getSalesAgentSales(
            $this->fromDate,
            $this->toDate,
        );
