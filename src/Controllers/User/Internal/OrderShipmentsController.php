 ...
 */
class OrderShipmentsController extends BaseHtmlController {
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        Loader::service(Services::ORDER)->addGetOrder($requests, self::ORDER, $this->getRequestParam(Parameters::ID, true));
    }
