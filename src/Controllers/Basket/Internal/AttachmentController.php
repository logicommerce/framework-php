...
/**
 * This is the AttachmentController controller class.
 * This class extends FWK\Core\Controllers\BaseJsonController, see this class.
 *
 * @controllerData: 
 *  <p>self::RESPONSE[self::DATA] => \SDK\Dtos\Basket\Attachment</p>
 * 
 * @RouteType: \FWK\Enums\RouteTypes\InternalBasket::ATTACHMENT
 *
 * @package FWK\Controllers\Basket\Internal
 */
class AttachmentController extends BaseJsonController {

    private ?BasketService $basketService = null;

    protected ?AttachmentParametersGroup $attachmentParametersGroup = null;
    ...
    public function __construct(Route $route) {
        ...
        $this->attachmentParametersGroup = new AttachmentParametersGroup();
    }
    ...
    protected function getFilterParams(): array {
        return FilterInputFactory::getPathParameter();
    }
    ...
    protected function initializeAppliedParameters(): void {
        $this->appliedParameters = $this->basketService->generateParametersGroupFromArray($this->attachmentParametersGroup, $this->getRequestParams());
    }
    ...
    protected function getResponseData(): ?Element {
        $response = $this->basketService->getAttachment($this->attachmentParametersGroup);
