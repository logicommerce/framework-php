...
/**
 * This is the RedeemRewardPointsController controller class.
 ...
 * 
 * @RouteType: \FWK\Enums\RouteTypes\InternalBasket::REDEEM_REWARD_POINTS
 *
 * @package FWK\Controllers\Basket\Internal
 */
class RedeemRewardPointsController extends BaseJsonController {
    use RedeemRewardPointsTrait;
    ...
    protected function getFilterParams(): array {
        return FilterInputFactory::getRedeemRewardPointsParameters();
    }
    ...
    protected function getResponseData(): ?Element {
        return $this->getRedeemRewardPointsResponseData();
    }
