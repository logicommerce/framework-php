...
/**
 * This is the DeleteSaveForLaterRowController class.
 * This class extends BaseJsonController, see this class.<br>
 *
 * @controllerData: 
 *  <p>self::RESPONSE[self::DATA] => \SDK\Core\Dtos\Status</p>
 * 
 * @RouteType: \FWK\Enums\RouteTypes\InternalBasket::BASKET_INTERNAL_DELETE_SAVE_FOR_LATER_ROW
 * 
 * @package FWK\Controllers\Basket\Internal
 */
class DeleteSaveForLaterRowController extends BaseJsonController {
    ...
    protected function getResponseData(): ?Element {
        return $this->userService->deleteSaveForLaterListRow($this->getRequestParam(Parameters::ID, true));
    }
