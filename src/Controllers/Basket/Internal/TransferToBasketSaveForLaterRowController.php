...
/**
 * This is the TransferToBasketSaveForLaterRowController class.
 * This class extends BaseJsonController, see this class.<br>
 *
 * @controllerData: 
 *  <p>self::RESPONSE[self::DATA] => \SDK\Dtos\Basket\Basket</p>
 * 
 * @RouteType: \FWK\Enums\RouteTypes\InternalBasket::TRANSFER_TO_BASKET_SAVE_FOR_LATER_ROW
 *
 * @package FWK\Controllers\Basket\Internal
 */
class TransferToBasketSaveForLaterRowController extends BaseJsonController {
    ...
    protected function getResponseData(): ?Element {
        return $this->userService->transferToBasketSaveForLaterListRow($this->getRequestParam(Parameters::ID, true));
    }
