...
/**
 * This is the DeleteRowController class.
 * This class extends BaseJsonController, see this class.<br>
 *
 * @controllerData: 
 *  <p>self::RESPONSE[self::DATA] => \SDK\Dtos\Basket\Basket</p>
 * 
 * @RouteType: \FWK\Enums\RouteTypes\InternalBasket::DELETE_ROW
 *
 * @package FWK\Controllers\Basket\Internal
 */
class DeleteRowController extends BaseJsonController {
    use DeleteRowTrait;
    ...
    protected function getFilterParams(): array {
        return FilterInputFactory::getDeleteRowParameters();
    }
    ...
    protected function getResponseData(): ?Element {
        return $this->getDeleteRowResponseData();
    }
