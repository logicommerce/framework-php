...
/**
 * This is the Featured Products controller class.
 ...
 */
class FeaturedProductsController extends BaseHtmlController {
    ...
    public function __construct(Route $route) {
        $this->initFiltrableProductList(self::CONTROLLER_ITEM, self::getTheme()->getConfiguration()->getFeatured()->getProductList());
