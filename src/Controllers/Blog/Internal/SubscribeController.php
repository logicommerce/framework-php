...
/**
 * This is the blog Subscribe Controller.
 ...
 */
class SubscribeController extends BaseJsonController {
    use CheckCaptcha;
    ...
    public function __construct(Route $route) {
        ...
        $this->responseMessage = $this->language->getLabelValue(LanguageLabels::BLOG_SUBSCRIPTION_FORM_OK, $this->responseMessage);
    }
    ...
    protected function getFilterParams(): array {
        $subscribeForm = FormFactory::getBlogSubscribe(FormFactory::BLOG_SUBSCRIBE);
    ...
    protected function getResponseData(): ?Element {
        ...
        $response = Loader::service(Services::BLOG)->subscribe($this->appliedParameters[Parameters::EMAIL]);
