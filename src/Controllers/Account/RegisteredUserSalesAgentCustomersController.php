 ...
 */
class RegisteredUserSalesAgentCustomersController extends BaseHtmlController {
    ...
    protected function getFilterParams(): array {
        return FormFactory::getAccountSalesAgentCustomers()->getInputFilterParameters() +
    ...
    protected function initializeAppliedParameters(): void {
        ...
        $this->accountService->generateParametersGroupFromArray($this->salesAgentCustomersParametersGroup, $requestParams);
    }
    ...
    final protected function setControllerBaseBatchData(BatchRequests $requests): void {
        if (!$this->getAllSalesAgentCustomers) {
            $this->accountService->addGetSalesAgentCustomers($requests, self::SALES_AGENT_CUSTOMERS, $this->salesAgentCustomersParametersGroup);
        }
    }
