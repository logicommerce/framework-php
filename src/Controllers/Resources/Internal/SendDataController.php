...
/**
 * This is the send data controller.
 ...
 */
class SendDataController extends BaseJsonController {
    ...
    protected function getFilterParams(): array {
        return FormFactory::getDeleteAccount()->getInputFilterParameters();
    }
    ...
    protected function getResponseData(): ?Element {
        $response = $this->userService->deleteUser($this->getRequestParam(Parameters::PASSWORD, true));
